...
CronCoin Core. It supports cross-compilation. For more details see [description.md](description.md),
...
## Configuring CronCoin Core

**When configuring CronCoin Core, CMake by default will ignore the depends output.** In
...
created. To use it during configuring CronCoin Core:
...
variables will be set when generating the CronCoin Core buildsystem. In this case, `-DENABLE_WALLET=OFF`.
