# Copyright (c) 2025-present The Cron Coin Core developers
...
function(extract_strings output)
  ...
  file(STRINGS "croncoinstrings.po" text ENCODING "UTF-8")
...
static const char UNUSED *croncoin_strings[] = {
  ...
  set(prefix "QT_TRANSLATE_NOOP(\"croncoin-core\", \"")
  set(suffix "\"),\n")
...
extract_strings("${PROJECT_SOURCE_DIR}/src/qt/croncoinstrings.cpp"
...
execute_process(
  COMMAND ${LUPDATE_EXECUTABLE}
    ...
    ${PROJECT_SOURCE_DIR}/src/qt/croncoinstrings.cpp
    -ts ${PROJECT_SOURCE_DIR}/src/qt/locale/croncoin_en.ts
  COMMAND_ERROR_IS_FATAL ANY
)
...
execute_process(
  COMMAND ${LCONVERT_EXECUTABLE}
    -drop-translations
    -o ${PROJECT_SOURCE_DIR}/src/qt/locale/croncoin_en.xlf
    -i ${PROJECT_SOURCE_DIR}/src/qt/locale/croncoin_en.ts
  COMMAND_ERROR_IS_FATAL ANY
)

file(READ "${PROJECT_SOURCE_DIR}/src/qt/locale/croncoin_en.xlf" croncoin_en)
string(REPLACE "source-language=\"en\" target-language=\"en\""
  "source-language=\"en\"" croncoin_en "${croncoin_en}"
)
string(REGEX REPLACE " *<target xml:space=\"preserve\"></target>\n"
  "" croncoin_en "${croncoin_en}"
)
file(WRITE "${PROJECT_SOURCE_DIR}/src/qt/locale/croncoin_en.xlf" "${croncoin_en}")
