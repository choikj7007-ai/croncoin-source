...
Assumeutxo is a feature that allows fast bootstrapping of a validating croncoind
instance.
...
```
$ croncoin-cli -rpcclienttimeout=0 loadtxoutset /path/to/input
```
...
```
$ croncoin-cli -rpcclienttimeout=0 dumptxoutset /path/to/output rollback
```
