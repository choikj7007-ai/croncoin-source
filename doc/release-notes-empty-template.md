...
Cron Coin Core version *version* is now available from:

  <https://croncoincore.org/bin/croncoin-core-*version*/>
...
Cron Coin Core is supported and tested on the following operating systems or newer:
Linux Kernel 3.17, macOS 14, and Windows 10 (version 1903). CronCoin
