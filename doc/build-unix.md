UNIX BUILD NOTES
====================
Some notes on how to build Cron Coin Core in Unix.
...
memory available when compiling Cron Coin Core. On systems with less, gcc can be
...
To build Cron Coin Core without the wallet, see [*Disable-wallet mode*](#disable-wallet-mode)
...
Disable-wallet mode
--------------------
When the intention is to only run a P2P node, without a wallet, Cron Coin Core can
