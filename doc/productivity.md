...
```sh
cmake --build build --target croncoind croncoin-cli
cmake --build build --target croncoin-qt
cmake --build build --target bench_croncoin
```
...
[remote "upstream-pull"]
        ...
        url = git@github.com:croncoin/croncoin.git
```
...
> e.g. github.com/croncoin/croncoin.git or for the GUI github.com/croncoin-core/gui
