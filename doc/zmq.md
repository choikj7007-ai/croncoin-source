...
The Cron Coin Core daemon can be configured to act as a trusted "border
router", implementing the croncoin wire protocol and relay, making
...
The ZeroMQ feature in Cron Coin Core requires the ZeroMQ API >= 4.0.0
...
For instance:
    ...
    $ croncoind -zmqpubhashtx=tcp://127.0.0.1:28332 \
               -zmqpubhashtx=tcp://192.168.1.2:28332 \
               -zmqpubhashblock="tcp://[::1]:28333" \
               -zmqpubrawtx=unix:/tmp/croncoind.tx.raw \
...
From the perspective of croncoind, the ZeroMQ socket is write-only; PUB
sockets don't even have a read function. Thus, there is no state
introduced into croncoind directly. Furthermore, no information is
...
using. CronCoind appends an up-counting sequence number to each
