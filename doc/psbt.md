# PSBT Howto for Cron Coin Core

Since Cron Coin Core 0.17, an RPC interface exists for Partially Signed CronCoin
Transactions (PSBTs, as specified in
[BIP 174](https://github.com/croncoin/bips/blob/master/bip-0174.mediawiki)).
...
PSBT is an interchange format for CronCoin transactions that are not fully signed
...
#### Multisig with multiple Cron Coin Core instances
