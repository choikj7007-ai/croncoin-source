Cron Coin Core version 0.13.2 is now available from:

  <https://croncoin.org/bin/croncoin-core-0.13.2/>
...
- #8908 `4a974b2` Update croncoin-qt.desktop (s-matthew-english)
...
- #8932 `106da69` Allow croncoin-tx to create v2 transactions (btcdrak)
