Cron Coin Core version 0.10.4 is now available from:

  <https://croncoin.org/bin/croncoin-core-0.10.4/>
...
- #6953 `43c2789` Split croncoin-tx into its own package
- #6953 `dfe0d4d` Include croncoin-tx binary on Debian/Ubuntu
