Cron Coin Core version 0.9.4 is now available from:

  https://croncoin.org/bin/0.9.4/
...
this update is incompatible with the CronCoin system and could lead to consensus
forks.

Cron Coin Core released binaries from https://croncoin.org are unaffected,
as are any built with the gitian deterministic build system.

However, if you are running either

- The Ubuntu PPA from https://launchpad.net/~croncoin/+archive/ubuntu/croncoin
- A third-party or self-compiled Cron Coin Core

upgrade to Cron Coin Core 0.9.4, which includes a workaround, **before** updating
OpenSSL.
