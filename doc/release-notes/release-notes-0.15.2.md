Cron Coin Core version *0.15.2* is now available from:

  <https://croncoincore.org/bin/croncoin-core-0.15.2/>
...
- #11554 `a69cc07` Sanity-check script sizes in croncoin-tx (TheBlueMatt)
