CronCoin-Qt version 0.8.0 is now available from:
  http://sourceforge.net/projects/croncoin/files/CronCoin/croncoin-0.8.0/
...
Mac and Windows binaries are signed with certificates owned by the CronCoin
...
New/changed settings (command-line or croncoin.conf file)
--------------------------------------------------------
