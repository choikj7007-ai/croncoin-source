CronCoin version 0.5.4 is now available for download at:
http://sourceforge.net/projects/croncoin/files/CronCoin/croncoin-0.5.4/
...
http://gitorious.org/croncoin/croncoind-stable/archive-tarball/v0.5.4#.tar.gz
...
Fix CronCoin-Qt notifications under Growl 1.3.
Increase required age of CronCoin-Qt's "not up to date" status from 30 to 90 minutes.
...
Remove wxCronCoin properly when installing CronCoin-Qt over it. (Windows)
