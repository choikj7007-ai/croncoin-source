Cron Coin Core version 0.16.1 is now available from:

  <https://croncoincore.org/bin/croncoin-core-0.16.1/>
...
- #12843 `df38b13` Test starting croncoind with -h and -version (jnewbery)
...
- #12904 `6c26df0` Ensure croncoind processes are cleaned up when tests end (sdaftuar)
