...
#ifndef CRONCOIN_PROTOCOL_H
#define CRONCOIN_PROTOCOL_H
...
/**
 * CronCoin protocol message types. When adding new message types, don't forget
...
enum ServiceFlags : uint64_t {
    ...
    // set by all CronCoin Core non pruned nodes, and is unset by SPV clients or other light clients.
    NODE_NETWORK = (1 << 0),
    ...
    // croncoin-development mailing list. Remember that service bits are just
