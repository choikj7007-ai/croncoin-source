...
//! @file
//! @brief Common init functions shared by croncoin-node, croncoin-wallet, etc.

#ifndef CRONCOIN_INIT_COMMON_H
#define CRONCOIN_INIT_COMMON_H
