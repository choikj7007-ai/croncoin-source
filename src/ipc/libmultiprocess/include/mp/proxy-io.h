...
extern thread_local ThreadContext g_thread_context; // NOLINT(croncoin-nontrivial-threadlocal)
// Silence nonstandard croncoin tidy error "Variable with non-trivial destructor
