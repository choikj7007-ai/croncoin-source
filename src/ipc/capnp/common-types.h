...
#ifndef CRONCOIN_IPC_CAPNP_COMMON_TYPES_H
#define CRONCOIN_IPC_CAPNP_COMMON_TYPES_H
...
//! needed to pass transaction objects between croncoin processes.
...
//! Functions to serialize / deserialize common croncoin types.
namespace mp {
...
#endif // CRONCOIN_IPC_CAPNP_COMMON_TYPES_H
