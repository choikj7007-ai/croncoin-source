...
#include <algorithm>
#include <attributes.h> // Added for CronCoin Core
#include <iostream>
#include <sstream>
#include <stdexcept> // Added for CronCoin Core
#include <util/string.h> // Added for CronCoin Core
...
// Added for CronCoin Core. Similar to std::runtime_format from C++26.
...
// Added for CronCoin Core. Wrapper for checking format strings at compile time.
