...
#ifndef CRONCOIN_POLICY_FEERATE_H
#define CRONCOIN_POLICY_FEERATE_H
...
const std::string CURRENCY_UNIT = "CRN"; // One formatted unit
const std::string CURRENCY_ATOM = "cro"; // One indivisible minimum value unit
...
#endif // CRONCOIN_POLICY_FEERATE_H
