...
#ifndef CRONCOIN_POLICY_FEES_BLOCK_POLICY_ESTIMATOR_H
#define CRONCOIN_POLICY_FEES_BLOCK_POLICY_ESTIMATOR_H
...
#endif // CRONCOIN_POLICY_FEES_BLOCK_POLICY_ESTIMATOR_H
