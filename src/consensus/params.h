...
#ifndef CRONCOIN_CONSENSUS_PARAMS_H
#define CRONCOIN_CONSENSUS_PARAMS_H
...
struct Params {
    ...
    /**
     * If true, witness commitments contain a payload equal to a CronCoin Script solution
...
#endif // CRONCOIN_CONSENSUS_PARAMS_H
