...
#ifndef CRONCOIN_TXREQUEST_H
#define CRONCOIN_TXREQUEST_H
 ...
 *   specific transaction. See https://croncoincore.org/en/2024/07/03/disclose_already_asked_for.
 */
