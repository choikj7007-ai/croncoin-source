...
#ifndef CRONCOIN_NODE_CONNECTION_TYPES_H
#define CRONCOIN_NODE_CONNECTION_TYPES_H
 ...
 * src/qt/guiutil.cpp and src/croncoin-cli.cpp::NetinfoRequestHandler. */
enum class ConnectionType {
     ...
     * Note that in the literature ("Eclipse Attacks on CronCoin’s Peer-to-Peer Network")
...
#endif // CRONCOIN_NODE_CONNECTION_TYPES_H
