...
#ifndef CRONCOIN_INTERFACES_INIT_H
#define CRONCOIN_INTERFACES_INIT_H
...
//! (croncoin-gui, croncoin-node, croncoin-wallet, croncoind, croncoin-qt) and each
...
#endif // CRONCOIN_INTERFACES_INIT_H
