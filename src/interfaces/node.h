...
#ifndef CRONCOIN_INTERFACES_NODE_H
#define CRONCOIN_INTERFACES_NODE_H
...
//! Top-level interface for a croncoin node (croncoind process).
class Node
{
public:
    ...
    //! Return setting value from <datadir>/settings.json or croncoin.conf.
...
#endif // CRONCOIN_INTERFACES_NODE_H
