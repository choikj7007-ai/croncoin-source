...
{
    BOOST_CHECK(TestSplitHost("www.croncoincore.org", "www.croncoincore.org", 0));
    BOOST_CHECK(TestSplitHost("[www.croncoincore.org]", "www.croncoincore.org", 0));
    BOOST_CHECK(TestSplitHost("www.croncoincore.org:80", "www.croncoincore.org", 80));
    BOOST_CHECK(TestSplitHost("[www.croncoincore.org]:80", "www.croncoincore.org", 80));
    ...
    BOOST_CHECK(TestSplitHost("www.croncoincore.org:65536", "www.croncoincore.org:65536", 0, false));
    BOOST_CHECK(TestSplitHost("www.croncoincore.org:0", "www.croncoincore.org", 0, false));
    BOOST_CHECK(TestSplitHost("www.croncoincore.org:", "www.croncoincore.org:", 0, false));
}
