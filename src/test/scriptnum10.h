...
#ifndef CRONCOIN_TEST_SCRIPTNUM10_H
#define CRONCOIN_TEST_SCRIPTNUM10_H
...
{
/**
 * The ScriptNum implementation from CronCoin Core 0.10.0, for cross-comparison.
 */
public:
...
#endif // CRONCOIN_TEST_SCRIPTNUM10_H
