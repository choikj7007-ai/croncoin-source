...
#ifndef CRONCOIN_UNIVALUE_INCLUDE_UNIVALUE_UTFFILTER_H
#define CRONCOIN_UNIVALUE_INCLUDE_UNIVALUE_UTFFILTER_H
...
#endif // CRONCOIN_UNIVALUE_INCLUDE_UNIVALUE_UTFFILTER_H
