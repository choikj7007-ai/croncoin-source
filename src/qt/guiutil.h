...
#ifndef CRONCOIN_QT_GUIUTIL_H
#define CRONCOIN_QT_GUIUTIL_H
...
/** Utility functions used by the CronCoin Qt UI.
 */
namespace GUIUtil
{
    ...
    // Parse "croncoin:" URI into recipient object, return true on successful parsing
