...
#ifndef CRONCOIN_QT_OPTIONSMODEL_H
#define CRONCOIN_QT_OPTIONSMODEL_H
...
/** Interface from Qt to configuration data structure for CronCoin client.
...
public:
    ...
    CronCoinUnit getDisplayUnit() const { return m_display_croncoin_unit; }
...
private:
    ...
    QString language;
    CronCoinUnit m_display_croncoin_unit;
...
Q_SIGNALS:
    void displayUnitChanged(CronCoinUnit unit);
...
#endif // CRONCOIN_QT_OPTIONSMODEL_H
