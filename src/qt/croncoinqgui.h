...
#ifndef CRONCOIN_QT_CRONCOINQGUI_H
#define CRONCOIN_QT_CRONCOINQGUI_H
...
/**
  CronCoin GUI main class. This class represents the main window of the CronCoin UI. It communicates with both the client and
  wallet models to give the user an up-to-date view of the current core state.
*/
class CronCoinGUI : public QMainWindow
{
    Q_OBJECT
...
public:
    ...
    explicit CronCoinGUI(interfaces::Node& node, const PlatformStyle *platformStyle, const NetworkStyle *networkStyle, QWidget *parent = nullptr);
    ~CronCoinGUI();
    ...
    */
    ...
    /** Set the wallet model.
        The wallet model represents a croncoin wallet, and offers access to the list of transactions, address book and sending
        functionality.
    */
...
public Q_SLOTS:
    ...
    void incomingTransaction(const QString& date, CronCoinUnit unit, const CAmount& amount, const QString& type, const QString& address, const QString& label, const QString& walletName);
#endif // ENABLE_WALLET
...
public Q_SLOTS:
    ...
    /** Load Partially Signed CronCoin Transaction from file or clipboard */
...
private Q_SLOTS:
    ...
    void updateDisplayUnit(CronCoinUnit newUnits);
    /** Tells underlying optionsModel to update its current display unit. */
    void onMenuSelection(QAction* action);
};

#endif // CRONCOIN_QT_CRONCOINQGUI_H
