...
#ifndef CRONCOIN_QT_SENDCOINSENTRY_H
#define CRONCOIN_QT_SENDCOINSENTRY_H
...
/**
 * A single entry in the dialog for sending croncoins.
 */
...
#endif // CRONCOIN_QT_SENDCOINSENTRY_H
