...
public:
                      ...
                      const QModelIndex &index ) const override
    {
        ...
        painter->setPen(foreground);
        QString amountText = CronCoinUnits::formatWithUnit(unit, amount, true, CronCoinUnits::SeparatorStyle::ALWAYS);
        if(!confirmed)
        {
    ...
    CronCoinUnit unit{CronCoinUnit::BTC};
...
{
    CronCoinUnit unit = walletModel->getOptionsModel()->getDisplayUnit();
    ui->labelBalance->setText(CronCoinUnits::formatWithPrivacy(unit, balances.balance, CronCoinUnits::SeparatorStyle::ALWAYS, m_privacy));
    ui->labelUnconfirmed->setText(CronCoinUnits::formatWithPrivacy(unit, balances.unconfirmed_balance, CronCoinUnits::SeparatorStyle::ALWAYS, m_privacy));
    ui->labelImmature->setText(CronCoinUnits::formatWithPrivacy(unit, balances.immature_balance, CronCoinUnits::SeparatorStyle::ALWAYS, m_privacy));
    ui->labelTotal->setText(CronCoinUnits::formatWithPrivacy(unit, balances.balance + balances.unconfirmed_balance + balances.immature_balance, CronCoinUnits::SeparatorStyle::ALWAYS, m_privacy));
