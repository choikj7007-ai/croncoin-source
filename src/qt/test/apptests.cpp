...
//! Entry point for CronCoinApplication tests.
void AppTests::appTests()
{
    ...
    connect(&m_app, &CronCoinApplication::windowShown, this, &AppTests::guiTests);
...
//! Entry point for CronCoinGUI tests.
void AppTests::guiTests(CronCoinGUI* window)
{
    HandleCallback callback{"guiTests", *this};
    connect(window, &CronCoinGUI::consoleShown, this, &AppTests::consoleTests);
