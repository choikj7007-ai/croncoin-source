...
{
    // Test regression https://github.com/croncoin/croncoin/issues/24457. Ensure
...
{
    // Test that the bug https://github.com/croncoin-core/gui/issues/567 does not resurface.
    // It was fixed via https://github.com/croncoin-core/gui/pull/568.
    // With fListen=false in ~/.config/CronCoin/CronCoin-Qt.conf and all else left as default,
    // croncoin-qt should set both -listen and -listenonion to false and start successfully.
