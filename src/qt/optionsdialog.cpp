      ...
      ui(new Ui::OptionsDialog)
{
    ...
    ui->croncoinAtStartup->setVisible(false);
    ui->verticalLayout_Main->removeWidget(ui->croncoinAtStartup);
    ...
    ui->croncoinAtStartup->setToolTip(ui->croncoinAtStartup->toolTip().arg(CLIENT_NAME));
    ui->croncoinAtStartup->setText(ui->croncoinAtStartup->text().arg(CLIENT_NAME));

    ui->openCronCoinConfButton->setToolTip(ui->openCronCoinConfButton->toolTip().arg(CLIENT_NAME));
    ...
    ui->unit->setModel(new CronCoinUnits(this));
...
{
    /* Main */
    mapper->addMapping(ui->croncoinAtStartup, OptionsModel::StartAtStartup);
...
void OptionsDialog::on_openCronCoinConfButton_clicked()
{
