...
#ifndef CRONCOIN_QT_RECEIVECOINSDIALOG_H
#define CRONCOIN_QT_RECEIVECOINSDIALOG_H
...
/** Dialog for requesting payment of croncoins */
...
#endif // CRONCOIN_QT_RECEIVECOINSDIALOG_H
