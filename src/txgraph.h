...
#ifndef CRONCOIN_TXGRAPH_H
#define CRONCOIN_TXGRAPH_H
 ...
 *
 * For more explanation, see https://delvingcroncoin.org/t/introduction-to-cluster-linearization/1032
 *
