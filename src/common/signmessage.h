...
#ifndef CRONCOIN_COMMON_SIGNMESSAGE_H
#define CRONCOIN_COMMON_SIGNMESSAGE_H
 ...
 * @param[in] address Signer's croncoin address, it must refer to a public key.
...
#endif // CRONCOIN_COMMON_SIGNMESSAGE_H
