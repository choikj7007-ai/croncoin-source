...
#ifndef CRONCOIN_COMMON_ARGS_H
#define CRONCOIN_COMMON_ARGS_H
...
extern const char * const CRONCOIN_CONF_FILENAME;
extern const char * const CRONCOIN_SETTINGS_FILENAME;
