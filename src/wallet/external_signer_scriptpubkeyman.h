...
#ifndef CRONCOIN_WALLET_EXTERNAL_SIGNER_SCRIPTPUBKEYMAN_H
#define CRONCOIN_WALLET_EXTERNAL_SIGNER_SCRIPTPUBKEYMAN_H
...
#endif // CRONCOIN_WALLET_EXTERNAL_SIGNER_SCRIPTPUBKEYMAN_H
