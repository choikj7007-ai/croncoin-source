...
#ifndef CRONCOIN_WALLET_WALLETUTIL_H
#define CRONCOIN_WALLET_WALLETUTIL_H
...
enum WalletFlags : uint64_t {
    ...
    //! croncoin from opening the wallet, thinking it was newly created, and
...
#endif // CRONCOIN_WALLET_WALLETUTIL_H
