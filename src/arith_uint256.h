...
#ifndef CRONCOIN_ARITH_UINT256_H
#define CRONCOIN_ARITH_UINT256_H
...
public:
     ...
     *
     * CronCoin only uses this "compact" format for encoding difficulty
...
#endif // CRONCOIN_ARITH_UINT256_H
