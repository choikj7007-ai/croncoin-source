...
const std::string EXAMPLE_ADDRESS[2] = {"crn1q09vkwtzgnqdz9xw35z65dxj5zwqpszd93y73ey", "crn1q02466gwtgv64z4zk5jcqsqj4jdt8kkjywje7s5"};
...
CFeeRate ParseFeeRate(const UniValue& json)
{
    ...
    if (val >= 1000 * COIN) throw JSONRPCError(RPC_INVALID_PARAMETER, "Fee rates larger than or equal to 1000CRN/kvB are not accepted");
    return CFeeRate{val};
}
...
{
    return "> croncoin-cli " + methodname + " " + args + "\n";
}

std::string HelpExampleCliNamed(const std::string& methodname, const RPCArgList& args)
{
    std::string result = "> croncoin-cli -named " + methodname;
