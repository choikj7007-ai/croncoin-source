...
#ifndef CRONCOIN_TXMEMPOOL_H
#define CRONCOIN_TXMEMPOOL_H
 ...
 * CronCoin-specific logic. Specifically, TxGraph handles (for each transaction)
 ...
 *
 * CTxMemPool itself handles the CronCoin-specific parts of mempool
