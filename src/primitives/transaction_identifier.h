...
#ifndef CRONCOIN_PRIMITIVES_TRANSACTION_IDENTIFIER_H
#define CRONCOIN_PRIMITIVES_TRANSACTION_IDENTIFIER_H
...
#endif // CRONCOIN_PRIMITIVES_TRANSACTION_IDENTIFIER_H
