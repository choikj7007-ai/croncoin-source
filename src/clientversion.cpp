 ...
 * for both croncoind and croncoin-qt, to make it harder for attackers to
 * target servers or GUI users specifically.
 */
const std::string UA_NAME("CronCoin");


#include <croncoin-build-info.h>
// The <croncoin-build-info.h>, which is generated by the build environment (cmake/script/GenerateBuildInfo.cmake),
...
/**
 * Format the subversion field according to BIP 14 spec (https://github.com/croncoin/bips/blob/master/bip-0014.mediawiki)
 */
...
std::string CopyrightHolders(const std::string& strPrefix)
{
    ...
    // Make sure Cron Coin Core copyright is not removed by accident
    if (copyright_devs.find("Cron Coin Core") == std::string::npos) {
        strCopyrightHolders += "\n" + strPrefix + "The Cron Coin Core developers";
    }
...
{
    const std::string URL_SOURCE_CODE = "<https://github.com/croncoin/croncoin>";
