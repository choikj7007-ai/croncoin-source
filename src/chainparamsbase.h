...
#ifndef CRONCOIN_CHAINPARAMSBASE_H
#define CRONCOIN_CHAINPARAMSBASE_H
...
/**
 * CBaseChainParams defines the base parameters (shared between croncoin-cli and croncoind)
 * of a given instance of the CronCoin system.
 */
...
#endif // CRONCOIN_CHAINPARAMSBASE_H
