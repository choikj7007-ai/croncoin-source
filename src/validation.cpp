...
CAmount GetBlockSubsidy(int nHeight, const Consensus::Params& consensusParams)
{
    ...
    CAmount nSubsidy = 600000 * COIN;
    // Subsidy is cut in half every 175,000 blocks which will occur approximately every ~1 year.
    nSubsidy >>= halvings;
    return nSubsidy;
}
...
DisconnectResult Chainstate::DisconnectBlock(const CBlock& block, const CBlockIndex* pindex, CCoinsViewCache& view)
{
    ...
    // See https://github.com/croncoin/croncoin/issues/22596 for additional information.
...
bool IsBlockMutated(const CBlock& block, bool check_witness_root)
{
    ...
    if (block.vtx.empty() || !block.vtx[0]->IsCoinBase()) {
        ...
        // in "Weaknesses in CronCoin’s Merkle Root Construction":
        // https://lists.linuxfoundation.org/pipermail/croncoin-dev/attachments/20190225/a27d8837/attachment-0001.pdf).
        //
 ...
 *  grow our in-memory block index. See https://croncoincore.org/en/2024/07/03/disclose-header-spam.
 */
...
bool ChainstateManager::ProcessNewBlock(const std::shared_ptr<const CBlock>& block, bool force_processing, bool min_pow_checked, bool* new_block)
{
...

    {
        ...
        // https://lists.linuxfoundation.org/pipermail/croncoin-dev/2019-February/016697.html.  Because CheckBlock() is
