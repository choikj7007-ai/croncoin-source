...
#ifndef CRONCOIN_KERNEL_CRONCOINK_H
#define CRONCOIN_KERNEL_CRONCOINK_H
...
#ifndef CRONCOINK_API
    #ifdef CRONCOINK_BUILD
        #if defined(_WIN32)
            #define CRONCOINK_API __declspec(dllexport)
        #else
            #define CRONCOINK_API __attribute__((visibility("default")))
        #endif
    #else
        #if defined(_WIN32) && !defined(CRONCOINK_STATIC)
            #define CRONCOINK_API __declspec(dllimport)
        #else
            #define CRONCOINK_API
        #endif
    #endif
#endif
...
/* Warning attributes */
#if defined(__GNUC__)
    #define CRONCOINK_WARN_UNUSED_RESULT __attribute__((__warn_unused_result__))
#else
    #define CRONCOINK_WARN_UNUSED_RESULT
#endif

/**
 * CRONCOINK_ARG_NONNULL is a compiler attribute used to indicate that
 ...
 */
#if !defined(CRONCOINK_BUILD) && defined(__GNUC__)
    #define CRONCOINK_ARG_NONNULL(...) __attribute__((__nonnull__(__VA_ARGS__)))
#else
    #define CRONCOINK_ARG_NONNULL(...)
#endif
 ...
 *
 * This header currently exposes an API for interacting with parts of CronCoin
 ...
 * also not yet included in releases of CronCoin Core.
 *
...
/**
 * Function signature for the global logging callback. All croncoin kernel
 ...
 */
CRONCOINK_API btck_Transaction* CRONCOINK_WARN_UNUSED_RESULT btck_transaction_create(
 ...
 */
CRONCOINK_API btck_Transaction* CRONCOINK_WARN_UNUSED_RESULT btck_transaction_copy(
    const btck_Transaction* transaction) CRONCOINK_ARG_NONNULL(1);
 ...
 * @return                0 on success.
 */
CRONCOINK_API int btck_transaction_to_bytes(
    const btck_Transaction* transaction,
    btck_WriteBytes writer,
    void* user_data) CRONCOINK_ARG_NONNULL(1, 2);
 ...
 */
CRONCOINK_API size_t CRONCOINK_WARN_UNUSED_RESULT btck_transaction_count_outputs(
    const btck_Transaction* transaction) CRONCOINK_ARG_NONNULL(1);
 ...
 */
CRONCOINK_API const btck_TransactionOutput* CRONCOINK_WARN_UNUSED_RESULT btck_transaction_get_output_at(
    const btck_Transaction* transaction, size_t output_index) CRONCOINK_ARG_NONNULL(1);
 ...
 */
CRONCOINK_API const btck_TransactionInput* CRONCOINK_WARN_UNUSED_RESULT btck_transaction_get_input_at(
    const btck_Transaction* transaction, size_t input_index) CRONCOINK_ARG_NONNULL(1);
 ...
 */
CRONCOINK_API size_t CRONCOINK_WARN_UNUSED_RESULT btck_transaction_count_inputs(
    const btck_Transaction* transaction) CRONCOINK_ARG_NONNULL(1);
 ...
 * @return                The txid.
 */
CRONCOINK_API const btck_Txid* CRONCOINK_WARN_UNUSED_RESULT btck_transaction_get_txid(
    const btck_Transaction* transaction) CRONCOINK_ARG_NONNULL(1);

/**
 * Destroy the transaction.
 */
CRONCOINK_API void btck_transaction_destroy(btck_Transaction* transaction);
 ...
 */
CRONCOINK_API btck_PrecomputedTransactionData* CRONCOINK_WARN_UNUSED_RESULT btck_precomputed_transaction_data_create(
    const btck_Transaction* tx_to,
    const btck_TransactionOutput** spent_outputs, size_t spent_outputs_len) CRONCOINK_ARG_NONNULL(1);
 ...
 */
CRONCOINK_API btck_PrecomputedTransactionData* CRONCOINK_WARN_UNUSED_RESULT btck_precomputed_transaction_data_copy(
    const btck_PrecomputedTransactionData* precomputed_txdata) CRONCOINK_ARG_NONNULL(1);

/**
 * Destroy the precomputed transaction data.
 */
CRONCOINK_API void btck_precomputed_transaction_data_destroy(btck_PrecomputedTransactionData* precomputed_txdata);
 ...
 */
CRONCOINK_API btck_ScriptPubkey* CRONCOINK_WARN_UNUSED_RESULT btck_script_pubkey_create(
 ...
 */
CRONCOINK_API btck_ScriptPubkey* CRONCOINK_WARN_UNUSED_RESULT btck_script_pubkey_copy(
    const btck_ScriptPubkey* script_pubkey) CRONCOINK_ARG_NONNULL(1);
 ...
 */
CRONCOINK_API int CRONCOINK_WARN_UNUSED_RESULT btck_script_pubkey_verify(
    ...
    btck_ScriptVerifyStatus* status) CRONCOINK_ARG_NONNULL(1, 3);
 ...
 * @return                  0 on success.
 */
CRONCOINK_API int btck_script_pubkey_to_bytes(
    const btck_ScriptPubkey* script_pubkey,
    btck_WriteBytes writer,
    void* user_data) CRONCOINK_ARG_NONNULL(1, 2);
 ...
 */
CRONCOINK_API void btck_script_pubkey_destroy(btck_ScriptPubkey* script_pubkey);
 ...
 * @return                  The transaction output.
 */
CRONCOINK_API btck_TransactionOutput* CRONCOINK_WARN_UNUSED_RESULT btck_transaction_output_create(
    const btck_ScriptPubkey* script_pubkey,
    int64_t amount) CRONCOINK_ARG_NONNULL(1);
 ...
 * @return                       The script pubkey.
 */
CRONCOINK_API const btck_ScriptPubkey* CRONCOINK_WARN_UNUSED_RESULT btck_transaction_output_get_script_pubkey(
    const btck_TransactionOutput* transaction_output) CRONCOINK_ARG_NONNULL(1);
 ...
 * @return                       The amount.
 */
CRONCOINK_API int64_t CRONCOINK_WARN_UNUSED_RESULT btck_transaction_output_get_amount(
    const btck_TransactionOutput* transaction_output) CRONCOINK_ARG_NONNULL(1);
 ...
 */
CRONCOINK_API btck_TransactionOutput* CRONCOINK_WARN_UNUSED_RESULT btck_transaction_output_copy(
    const btck_TransactionOutput* transaction_output) CRONCOINK_ARG_NONNULL(1);

/**
 * Destroy the transaction output.
 */
CRONCOINK_API void btck_transaction_output_destroy(btck_TransactionOutput* transaction_output);
 ...
 * already exists.
 */
CRONCOINK_API void btck_logging_disable();
 ...
 */
CRONCOINK_API void btck_logging_set_options(btck_LoggingOptions options);
 ...
 */
CRONCOINK_API void btck_logging_set_level_category(btck_LogCategory category, btck_LogLevel level);
 ...
 */
CRONCOINK_API void btck_logging_enable_category(btck_LogCategory category);
 ...
 */
CRONCOINK_API void btck_logging_disable_category(btck_LogCategory category);
 ...
 */
CRONCOINK_API btck_LoggingConnection* CRONCOINK_WARN_UNUSED_RESULT btck_logging_connection_create(
    btck_LogCallback log_callback,
    void* user_data,
    btck_DestroyCallback user_data_destroy_callback) CRONCOINK_ARG_NONNULL(1);

/**
 * Stop logging and destroy the logging connection.
 */
CRONCOINK_API void btck_logging_connection_destroy(btck_LoggingConnection* logging_connection);
 ...
 */
CRONCOINK_API btck_ChainParameters* CRONCOINK_WARN_UNUSED_RESULT btck_chain_parameters_create(
    btck_ChainType chain_type);

/**
 * Copy the chain parameters.
 */
CRONCOINK_API btck_ChainParameters* CRONCOINK_WARN_UNUSED_RESULT btck_chain_parameters_copy(
    const btck_ChainParameters* chain_parameters) CRONCOINK_ARG_NONNULL(1);

/**
 * Destroy the chain parameters.
 */
CRONCOINK_API void btck_chain_parameters_destroy(btck_ChainParameters* chain_parameters);
 ...
 */
CRONCOINK_API btck_ContextOptions* CRONCOINK_WARN_UNUSED_RESULT btck_context_options_create();
 ...
 */
CRONCOINK_API void btck_context_options_set_chainparams(
    btck_ContextOptions* context_options,
    const btck_ChainParameters* chain_parameters) CRONCOINK_ARG_NONNULL(1, 2);
 ...
 */
CRONCOINK_API void btck_context_options_set_notifications(
    btck_ContextOptions* context_options,
    btck_NotificationInterfaceCallbacks notifications) CRONCOINK_ARG_NONNULL(1);
 ...
 *                                           user.
 */
CRONCOINK_API void btck_context_options_set_validation_interface(
    btck_ContextOptions* context_options,
    btck_ValidationInterfaceCallbacks validation_interface_callbacks) CRONCOINK_ARG_NONNULL(1);

/**
 * Destroy the context options.
 */
CRONCOINK_API void btck_context_options_destroy(btck_ContextOptions* context_options);
 ...
 */
CRONCOINK_API btck_Context* CRONCOINK_WARN_UNUSED_RESULT btck_context_create(
    const btck_ContextOptions* context_options);

/**
 * Copy the context.
 */
CRONCOINK_API btck_Context* CRONCOINK_WARN_UNUSED_RESULT btck_context_copy(
    const btck_Context* context) CRONCOINK_ARG_NONNULL(1);
 ...
 */
CRONCOINK_API int CRONCOINK_WARN_UNUSED_RESULT btck_context_interrupt(
    btck_Context* context) CRONCOINK_ARG_NONNULL(1);

/**
 * Destroy the context.
 */
CRONCOINK_API void btck_context_destroy(btck_Context* context);
 ...
 */
CRONCOINK_API const btck_BlockTreeEntry* CRONCOINK_WARN_UNUSED_RESULT btck_block_tree_entry_get_previous(
    const btck_BlockTreeEntry* block_tree_entry) CRONCOINK_ARG_NONNULL(1);
 ...
 */
CRONCOINK_API btck_BlockHeader* CRONCOINK_WARN_UNUSED_RESULT btck_block_tree_entry_get_block_header(
    const btck_BlockTreeEntry* block_tree_entry) CRONCOINK_ARG_NONNULL(1);
 ...
 */
CRONCOINK_API int32_t CRONCOINK_WARN_UNUSED_RESULT btck_block_tree_entry_get_height(
    const btck_BlockTreeEntry* block_tree_entry) CRONCOINK_ARG_NONNULL(1);
 ...
 */
CRONCOINK_API const btck_BlockHash* CRONCOINK_WARN_UNUSED_RESULT btck_block_tree_entry_get_block_hash(
    const btck_BlockTreeEntry* block_tree_entry) CRONCOINK_ARG_NONNULL(1);
 ...
 */
CRONCOINK_API int CRONCOINK_WARN_UNUSED_RESULT btck_block_tree_entry_equals(
    const btck_BlockTreeEntry* entry1, const btck_BlockTreeEntry* entry2) CRONCOINK_ARG_NONNULL(1, 2);
 ...
 */
CRONCOINK_API btck_ChainstateManagerOptions* CRONCOINK_WARN_UNUSED_RESULT btck_chainstate_manager_options_create(
    const btck_Context* context,
    const char* data_directory,
    size_t data_directory_len,
    const char* blocks_directory,
    size_t blocks_directory_len) CRONCOINK_ARG_NONNULL(1);
 ...
 */
CRONCOINK_API void btck_chainstate_manager_options_set_worker_threads_num(
    btck_ChainstateManagerOptions* chainstate_manager_options,
    int worker_threads) CRONCOINK_ARG_NONNULL(1);
 ...
 */
CRONCOINK_API int CRONCOINK_WARN_UNUSED_RESULT btck_chainstate_manager_options_set_wipe_dbs(
    btck_ChainstateManagerOptions* chainstate_manager_options,
    int wipe_block_tree_db,
    int wipe_chainstate_db) CRONCOINK_ARG_NONNULL(1);
 ...
 */
CRONCOINK_API void btck_chainstate_manager_options_update_block_tree_db_in_memory(
    btck_ChainstateManagerOptions* chainstate_manager_options,
    int block_tree_db_in_memory) CRONCOINK_ARG_NONNULL(1);
 ...
 */
CRONCOINK_API void btck_chainstate_manager_options_update_chainstate_db_in_memory(
    btck_ChainstateManagerOptions* chainstate_manager_options,
    int chainstate_db_in_memory) CRONCOINK_ARG_NONNULL(1);

/**
 * Destroy the chainstate manager options.
 */
CRONCOINK_API void btck_chainstate_manager_options_destroy(btck_ChainstateManagerOptions* chainstate_manager_options);
 ...
 */
CRONCOINK_API btck_ChainstateManager* CRONCOINK_WARN_UNUSED_RESULT btck_chainstate_manager_create(
    const btck_ChainstateManagerOptions* chainstate_manager_options) CRONCOINK_ARG_NONNULL(1);
 ...
 */
CRONCOINK_API const btck_BlockTreeEntry* CRONCOINK_WARN_UNUSED_RESULT btck_chainstate_manager_get_best_entry(
    const btck_ChainstateManager* chainstate_manager) CRONCOINK_ARG_NONNULL(1);
 ...
 */
CRONCOINK_API int CRONCOINK_WARN_UNUSED_RESULT btck_chainstate_manager_process_block_header(
    btck_ChainstateManager* chainstate_manager,
    const btck_BlockHeader* header,
    btck_BlockValidationState* block_validation_state) CRONCOINK_ARG_NONNULL(1, 2, 3);
 ...
 */
CRONCOINK_API int CRONCOINK_WARN_UNUSED_RESULT btck_chainstate_manager_import_blocks(
    btck_ChainstateManager* chainstate_manager,
    const char** block_file_paths_data, size_t* block_file_paths_lens,
    size_t block_file_paths_data_len) CRONCOINK_ARG_NONNULL(1);
 ...
 */
CRONCOINK_API int CRONCOINK_WARN_UNUSED_RESULT btck_chainstate_manager_process_block(
    btck_ChainstateManager* chainstate_manager,
    const btck_Block* block,
    int* new_block) CRONCOINK_ARG_NONNULL(1, 2, 3);
 ...
 * @return                       The chain.
 */
CRONCOINK_API const btck_Chain* CRONCOINK_WARN_UNUSED_RESULT btck_chainstate_manager_get_active_chain(
    const btck_ChainstateManager* chainstate_manager) CRONCOINK_ARG_NONNULL(1);
 ...
 */
CRONCOINK_API const btck_BlockTreeEntry* CRONCOINK_WARN_UNUSED_RESULT btck_chainstate_manager_get_block_tree_entry_by_hash(
    const btck_ChainstateManager* chainstate_manager,
    const btck_BlockHash* block_hash) CRONCOINK_ARG_NONNULL(1, 2);

/**
 * Destroy the chainstate manager.
 */
CRONCOINK_API void btck_chainstate_manager_destroy(btck_ChainstateManager* chainstate_manager);
 ...
 */
CRONCOINK_API btck_Block* CRONCOINK_WARN_UNUSED_RESULT btck_block_read(
    const btck_ChainstateManager* chainstate_manager,
    const btck_BlockTreeEntry* block_tree_entry) CRONCOINK_ARG_NONNULL(1, 2);
 ...
 */
CRONCOINK_API btck_Block* CRONCOINK_WARN_UNUSED_RESULT btck_block_create(
 ...
 */
CRONCOINK_API btck_Block* CRONCOINK_WARN_UNUSED_RESULT btck_block_copy(
    const btck_Block* block) CRONCOINK_ARG_NONNULL(1);
 ...
 */
CRONCOINK_API size_t CRONCOINK_WARN_UNUSED_RESULT btck_block_count_transactions(
    const btck_Block* block) CRONCOINK_ARG_NONNULL(1);
 ...
 */
CRONCOINK_API const btck_Transaction* CRONCOINK_WARN_UNUSED_RESULT btck_block_get_transaction_at(
    const btck_Block* block, size_t transaction_index) CRONCOINK_ARG_NONNULL(1);
 ...
 * @return          btck_BlockHeader.
 */
CRONCOINK_API btck_BlockHeader* CRONCOINK_WARN_UNUSED_RESULT btck_block_get_header(
    const btck_Block* block) CRONCOINK_ARG_NONNULL(1);
 ...
 * @return    The block hash.
 */
CRONCOINK_API btck_BlockHash* CRONCOINK_WARN_UNUSED_RESULT btck_block_get_hash(
    const btck_Block* block) CRONCOINK_ARG_NONNULL(1);
 ...
 * @return              0 on success.
 */
CRONCOINK_API int btck_block_to_bytes(
    const btck_Block* block,
    btck_WriteBytes writer,
    void* user_data) CRONCOINK_ARG_NONNULL(1, 2);
 ...
 * Destroy the block.
 */
CRONCOINK_API void btck_block_destroy(btck_Block* block);
 ...
 */
CRONCOINK_API btck_BlockValidationState* CRONCOINK_WARN_UNUSED_RESULT btck_block_validation_state_create();

/**
 * Returns the validation mode from an opaque btck_BlockValidationState pointer.
 */
CRONCOINK_API btck_ValidationMode btck_block_validation_state_get_validation_mode(
    const btck_BlockValidationState* block_validation_state) CRONCOINK_ARG_NONNULL(1);

/**
 * Returns the validation result from an opaque btck_BlockValidationState pointer.
 */
CRONCOINK_API btck_BlockValidationResult btck_block_validation_state_get_block_validation_result(
    const btck_BlockValidationState* block_validation_state) CRONCOINK_ARG_NONNULL(1);
 ...
 */
CRONCOINK_API btck_BlockValidationState* CRONCOINK_WARN_UNUSED_RESULT btck_block_validation_state_copy(
    const btck_BlockValidationState* block_validation_state) CRONCOINK_ARG_NONNULL(1);

/**
 * Destroy the btck_BlockValidationState.
 */
CRONCOINK_API void btck_block_validation_state_destroy(
    btck_BlockValidationState* block_validation_state) CRONCOINK_ARG_NONNULL(1);
 ...
 */
CRONCOINK_API int32_t CRONCOINK_WARN_UNUSED_RESULT btck_chain_get_height(
    const btck_Chain* chain) CRONCOINK_ARG_NONNULL(1);
 ...
 */
CRONCOINK_API const btck_BlockTreeEntry* CRONCOINK_WARN_UNUSED_RESULT btck_chain_get_by_height(
    const btck_Chain* chain,
    int block_height) CRONCOINK_ARG_NONNULL(1);
 ...
 *
 */
CRONCOINK_API int CRONCOINK_WARN_UNUSED_RESULT btck_chain_contains(
    const btck_Chain* chain,
    const btck_BlockTreeEntry* block_tree_entry) CRONCOINK_ARG_NONNULL(1, 2);
 ...
 */
CRONCOINK_API btck_BlockSpentOutputs* CRONCOINK_WARN_UNUSED_RESULT btck_block_spent_outputs_read(
    const btck_ChainstateManager* chainstate_manager,
    const btck_BlockTreeEntry* block_tree_entry) CRONCOINK_ARG_NONNULL(1, 2);
 ...
 */
CRONCOINK_API btck_BlockSpentOutputs* CRONCOINK_WARN_UNUSED_RESULT btck_block_spent_outputs_copy(
    const btck_BlockSpentOutputs* block_spent_outputs) CRONCOINK_ARG_NONNULL(1);
 ...
 */
CRONCOINK_API size_t CRONCOINK_WARN_UNUSED_RESULT btck_block_spent_outputs_count(
    const btck_BlockSpentOutputs* block_spent_outputs) CRONCOINK_ARG_NONNULL(1);
 ...
 */
CRONCOINK_API const btck_TransactionSpentOutputs* CRONCOINK_WARN_UNUSED_RESULT btck_block_spent_outputs_get_transaction_spent_outputs_at(
    const btck_BlockSpentOutputs* block_spent_outputs,
    size_t transaction_spent_outputs_index) CRONCOINK_ARG_NONNULL(1);

/**
 * Destroy the block spent outputs.
 */
CRONCOINK_API void btck_block_spent_outputs_destroy(btck_BlockSpentOutputs* block_spent_outputs);
 ...
 */
CRONCOINK_API btck_TransactionSpentOutputs* CRONCOINK_WARN_UNUSED_RESULT btck_transaction_spent_outputs_copy(
    const btck_TransactionSpentOutputs* transaction_spent_outputs) CRONCOINK_ARG_NONNULL(1);
 ...
 */
CRONCOINK_API size_t CRONCOINK_WARN_UNUSED_RESULT btck_transaction_spent_outputs_count(
    const btck_TransactionSpentOutputs* transaction_spent_outputs) CRONCOINK_ARG_NONNULL(1);
 ...
 */
CRONCOINK_API const btck_Coin* CRONCOINK_WARN_UNUSED_RESULT btck_transaction_spent_outputs_get_coin_at(
    const btck_TransactionSpentOutputs* transaction_spent_outputs,
    size_t coin_index) CRONCOINK_ARG_NONNULL(1);

/**
 * Destroy the transaction spent outputs.
 */
CRONCOINK_API void btck_transaction_spent_outputs_destroy(btck_TransactionSpentOutputs* transaction_spent_outputs);
 ...
 */
CRONCOINK_API btck_TransactionInput* CRONCOINK_WARN_UNUSED_RESULT btck_transaction_input_copy(
    const btck_TransactionInput* transaction_input) CRONCOINK_ARG_NONNULL(1);
 ...
 */
CRONCOINK_API const btck_TransactionOutPoint* CRONCOINK_WARN_UNUSED_RESULT btck_transaction_input_get_out_point(
    const btck_TransactionInput* transaction_input) CRONCOINK_ARG_NONNULL(1);

/**
 * Destroy the transaction input.
 */
CRONCOINK_API void btck_transaction_input_destroy(btck_TransactionInput* transaction_input);
 ...
 */
CRONCOINK_API btck_TransactionOutPoint* CRONCOINK_WARN_UNUSED_RESULT btck_transaction_out_point_copy(
    const btck_TransactionOutPoint* transaction_out_point) CRONCOINK_ARG_NONNULL(1);
 ...
 */
CRONCOINK_API uint32_t CRONCOINK_WARN_UNUSED_RESULT btck_transaction_out_point_get_index(
    const btck_TransactionOutPoint* transaction_out_point) CRONCOINK_ARG_NONNULL(1);
 ...
 * @return                          The txid.
 */
CRONCOINK_API const btck_Txid* CRONCOINK_WARN_UNUSED_RESULT btck_transaction_out_point_get_txid(
    const btck_TransactionOutPoint* transaction_out_point) CRONCOINK_ARG_NONNULL(1);

/**
 * Destroy the transaction out point.
 */
CRONCOINK_API void btck_transaction_out_point_destroy(btck_TransactionOutPoint* transaction_out_point);
 ...
 */
CRONCOINK_API btck_Txid* CRONCOINK_WARN_UNUSED_RESULT btck_txid_copy(
    const btck_Txid* txid) CRONCOINK_ARG_NONNULL(1);
 ...
 */
CRONCOINK_API int CRONCOINK_WARN_UNUSED_RESULT btck_txid_equals(
    const btck_Txid* txid1, const btck_Txid* txid2) CRONCOINK_ARG_NONNULL(1, 2);
 ...
 */
CRONCOINK_API void btck_txid_to_bytes(
    const btck_Txid* txid, unsigned char output[32]) CRONCOINK_ARG_NONNULL(1, 2);

/**
 * Destroy the txid.
 */
CRONCOINK_API void btck_txid_destroy(btck_Txid* txid);
 ...
 */
CRONCOINK_API btck_Coin* CRONCOINK_WARN_UNUSED_RESULT btck_coin_copy(
    const btck_Coin* coin) CRONCOINK_ARG_NONNULL(1);
 ...
 */
CRONCOINK_API uint32_t CRONCOINK_WARN_UNUSED_RESULT btck_coin_confirmation_height(
    const btck_Coin* coin) CRONCOINK_ARG_NONNULL(1);
 ...
 */
CRONCOINK_API int CRONCOINK_WARN_UNUSED_RESULT btck_coin_is_coinbase(
    const btck_Coin* coin) CRONCOINK_ARG_NONNULL(1);
 ...
 */
CRONCOINK_API const btck_TransactionOutput* CRONCOINK_WARN_UNUSED_RESULT btck_coin_get_output(
    const btck_Coin* coin) CRONCOINK_ARG_NONNULL(1);

/**
 * Destroy the coin.
 */
CRONCOINK_API void btck_coin_destroy(btck_Coin* coin);
 ...
 */
CRONCOINK_API btck_BlockHash* CRONCOINK_WARN_UNUSED_RESULT btck_block_hash_create(
    const unsigned char block_hash[32]) CRONCOINK_ARG_NONNULL(1);
 ...
 */
CRONCOINK_API int CRONCOINK_WARN_UNUSED_RESULT btck_block_hash_equals(
    const btck_BlockHash* hash1, const btck_BlockHash* hash2) CRONCOINK_ARG_NONNULL(1, 2);
 ...
 */
CRONCOINK_API btck_BlockHash* CRONCOINK_WARN_UNUSED_RESULT btck_block_hash_copy(
    const btck_BlockHash* block_hash) CRONCOINK_ARG_NONNULL(1);
 ...
 */
CRONCOINK_API void btck_block_hash_to_bytes(
    const btck_BlockHash* block_hash, unsigned char output[32]) CRONCOINK_ARG_NONNULL(1, 2);

/**
 * Destroy the block hash.
 */
CRONCOINK_API void btck_block_hash_destroy(btck_BlockHash* block_hash);
 ...
 */
CRONCOINK_API btck_BlockHeader* CRONCOINK_WARN_UNUSED_RESULT btck_block_header_create(
 ...
 */
CRONCOINK_API btck_BlockHeader* CRONCOINK_WARN_UNUSED_RESULT btck_block_header_copy(
    const btck_BlockHeader* header) CRONCOINK_ARG_NONNULL(1);
 ...
 */
CRONCOINK_API btck_BlockHash* CRONCOINK_WARN_UNUSED_RESULT btck_block_header_get_hash(
    const btck_BlockHeader* header) CRONCOINK_ARG_NONNULL(1);
 ...
 */
CRONCOINK_API const btck_BlockHash* CRONCOINK_WARN_UNUSED_RESULT btck_block_header_get_prev_hash(
    const btck_BlockHeader* header) CRONCOINK_ARG_NONNULL(1);
 ...
 */
CRONCOINK_API uint32_t CRONCOINK_WARN_UNUSED_RESULT btck_block_header_get_timestamp(
    const btck_BlockHeader* header) CRONCOINK_ARG_NONNULL(1);
 ...
 */
CRONCOINK_API uint32_t CRONCOINK_WARN_UNUSED_RESULT btck_block_header_get_bits(
    const btck_BlockHeader* header) CRONCOINK_ARG_NONNULL(1);
 ...
 */
CRONCOINK_API int32_t CRONCOINK_WARN_UNUSED_RESULT btck_block_header_get_version(
    const btck_BlockHeader* header) CRONCOINK_ARG_NONNULL(1);
 ...
 * @return              Nonce
 */
CRONCOINK_API uint32_t CRONCOINK_WARN_UNUSED_RESULT btck_block_header_get_nonce(
    const btck_BlockHeader* header) CRONCOINK_ARG_NONNULL(1);

/**
 * Destroy the btck_BlockHeader.
 */
CRONCOINK_API void btck_block_header_destroy(btck_BlockHeader* header);
...
#endif // CRONCOIN_KERNEL_CRONCOINK_H
