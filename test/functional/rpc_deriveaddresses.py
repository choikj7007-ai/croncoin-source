...
class DeriveaddressesTest(CronCoinTestFramework):
    ...
    def run_test(self):
        ...
        address = "crnrt1qjqmxmkpmxt80xz4y3746zgt0q3u3ferrznukj2"
        ...
        assert_equal(self.nodes[0].deriveaddresses(ranged_descriptor, [1, 2]), ["crnrt1qhku5rq7jz8ulufe2y6fkcpnlvpsta7rqxn5yj6", "crnrt1qpgptk2gvshyl0s9lqshsmx932l9ccsv2fj2zz7"])
        assert_equal(self.nodes[0].deriveaddresses(ranged_descriptor, 2), [address, "crnrt1qhku5rq7jz8ulufe2y6fkcpnlvpsta7rqxn5yj6", "crnrt1qpgptk2gvshyl0s9lqshsmx932l9ccsv2fj2zz7"])
        ...
        assert_equal(self.nodes[0].deriveaddresses(ranged_descriptor, [1, 2]), [["crnrt1q7c8mdmdktrzs8xgpjmqw90tjn65j5a3ypf54wd", "crnrt1qs6n37uzu0v0qfzf0r0csm0dwa7prc0v50mdxm3"], ["crnrt1qhku5rq7jz8ulufe2y6fkcpnlvpsta7rqxn5yj6", "crnrt1qpgptk2gvshyl0s9lqshsmx932l9ccsv2fj2zz7"]])
        ...
        # Before #26275, croncoind would crash when deriveaddresses was
        # called with derivation index 2147483647, which is the maximum
        # positive value of a signed int32, and - currently - the
        # maximum value that the deriveaddresses croncoin RPC call
        # accepts as derivation index.
        assert_equal(self.nodes[0].deriveaddresses(descsum_create("wpkh(tprv8ZgxMBicQKsPd7Uf69XL1XwhmjHopUGep8GuEiJDZmbQz6o58LninorQAfcKZWARbtRtfnLcJ5MQ2AtHcQJCCRUcMRvmDUjyEmNUWwx8UbK/1/1/*)"), [2147483647, 2147483647]), ["crnrt1qtzs23vgzpreks5gtygwxf8tv5rldxvvsh0qrfk"])
