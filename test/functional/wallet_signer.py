...
Verify that a croncoind node can use an external signer command
...
class WalletSignerTest(CronCoinTestFramework):
    ...
    def test_valid_signer(self):
        ...
        assert_equal(address1, "crnrt1qm90ugl4d48jv8n6e5t9ln6t9zlpm5th65q58ck")
        ...
        assert_equal(address4, "crnrt1phw4cgpt6cd30kz9k4wkpwm872cdvhss29jga2xpmftelhqll62mszeqg4a")
        ...
        assert_equal(address_fail, "crnrt1ql7zg7ukh3dwr25ex2zn9jse926f27xy2py4f59")
