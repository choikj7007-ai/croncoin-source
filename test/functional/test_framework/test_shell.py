...
class TestShell:
    """Wrapper Class for CronCoinTestFramework.

    The TestShell class extends the CronCoinTestFramework
    ...
    class __TestShell(CronCoinTestFramework):
        ...
        def setup(self, **kwargs):
            ...
            # by CronCoinTestFramework child class.
            self.num_nodes = 1
    ...
    def __new__(cls):
        ...
        if not TestShell.instance:
            # CronCoinTestFramework instances are supposed to be constructed with the path
