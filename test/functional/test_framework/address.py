...
"""Encode and decode CronCoin addresses.
...
ADDRESS_BCRT1_UNSPENDABLE = 'crnrt1qqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqxxep3a'
ADDRESS_BCRT1_UNSPENDABLE_DESCRIPTOR = 'addr(crnrt1qqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqxxep3a)#hgp00pgy'
# Coins sent to this address can be spent with a witness stack of just OP_TRUE
ADDRESS_BCRT1_P2WSH_OP_TRUE = 'crnrt1qft5p2uhsdcdc3l2ua4ap5qqfg4pjaqlp250x7us7a8qqhrxrxfsq8ecqjm'
...
def create_deterministic_address_bcrt1_p2tr_op_true(explicit_internal_key=None):
    ...
    if explicit_internal_key is None:
        assert_equal(address, 'crnrt1p9yfmy5h72durp7zrhlw9lf7jpwjgvwdg0jr0lqmmjtgg83266lqswkccrj')
...
def program_to_witness(version, program, main=False):
    ...
    return encode_segwit_address("crn" if main else "crnrt", version, program)
