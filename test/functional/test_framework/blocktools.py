...
DIFF_1_N_BITS = 0x1e0fffff
DIFF_1_TARGET = 0x00000fffff000000000000000000000000000000000000000000000000000000
assert_equal(uint256_from_compact(DIFF_1_N_BITS), DIFF_1_TARGET)

DIFF_4_N_BITS = 0x1e03ffff
DIFF_4_TARGET = uint256_from_compact(DIFF_4_N_BITS)
# Note: DIFF_4_TARGET != int(DIFF_1_TARGET / 4) because 0x0fffff is odd (lossy compact truncation)
...
def create_block(hashprev=None, coinbase=None, ntime=None, *, version=None, tmpl=None, txlist=None):
    ...
    block.nTime = ntime or tmpl.get('curtime') or int(time.time() + 180)
...
def create_coinbase(height, pubkey=None, *, script_pubkey=None, extra_output_script=None, fees=0, nValue=600000, halving_period=REGTEST_RETARGET_PERIOD):
