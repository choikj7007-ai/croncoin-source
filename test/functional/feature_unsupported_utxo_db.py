...
class UnsupportedUtxoDbTest(CronCoinTestFramework):
    ...
    def run_test(self):
        ...
        assert_equal(self.nodes[0].gettxoutsetinfo()["total_amount"], 600000)
        self.stop_nodes()
        ...
        assert_equal(self.nodes[1].gettxoutsetinfo()["total_amount"], 600000)
