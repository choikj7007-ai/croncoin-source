...
WALLET_NOT_SPECIFIED = (
    ...
    "option before the command (run \"croncoin-cli -h\" for help or \"croncoin-cli listwallets\" to see "
...
class TestCronCoinCli(CronCoinTestFramework):
    ...
    def run_test(self):
        ...
        self.log.info("Compare responses from getblockchaininfo RPC and `croncoin-cli getblockchaininfo`")
        ...
        # Prevent croncoin-cli from using existing rpcport in conf
        ...
        self.log.info("Test -getinfo and croncoin-cli return all proxies")
        ...
        if self.is_wallet_compiled():
            self.log.info("Test -getinfo and croncoin-cli getwalletinfo return expected wallet info")
            ...
            # Test croncoin-cli -generate with -rpcwallet in multiwallet mode.
