...
"""Verify that starting croncoin with -h works as expected."""

from test_framework.test_framework import CronCoinTestFramework
from test_framework.util import assert_equal

class HelpTest(CronCoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start croncoin with -h for help text")
        ...
        self.log.info("Start croncoin with -version for version information")
        ...
        self.log.info("Start croncoind with -fakearg to make sure it does not start")
