...
Verify that a croncoind node can load multiple wallet files
"""
...
class MultiWalletTest(CronCoinTestFramework):
    ...
    def run_test(self):
        ...
        assert_equal(set(node.listwallets()), {"w4", "w5"})
        w5 = wallet("w5")
        assert_equal(w5.getbalances()["mine"]["immature"], 600000)
        ...
        for wallet_name, wallet in zip(wallet_names, wallets):
            ...
            assert_equal(wallet.getbalances()["mine"]["immature"], 600000 if wallet is wallets[0] else 0)
        ...
        assert_equal(w1.getbalance(), 1200000)
        ...
        w2.settxfee(0.001)
        assert_equal(w1.getwalletinfo()['paytxfee'], 0)
        assert_equal(w2.getwalletinfo()['paytxfee'], Decimal('0.001'))
