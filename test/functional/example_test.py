...
def custom_function():
    ...
    # self.log.info("running custom_function")  # Oops! Can't run self.log outside the CronCoinTestFramework
    pass


class ExampleTest(CronCoinTestFramework):
    # Each functional test is a subclass of the CronCoinTestFramework class.
    ...
    def custom_method(self):
        ...
        CronCoinTestFramework class so other tests can use it."""
