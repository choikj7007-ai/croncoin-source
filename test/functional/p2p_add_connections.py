...
class P2PFeelerReceiver(P2PInterface):
    def on_version(self, message):
        # The croncoind node closes feeler connections as soon as a version
...
class P2PAddConnections(CronCoinTestFramework):
    ...
    def run_test(self):
        ...
        # croncoind behaves properly when a version is sent unexpectedly (but
        # tolerably) early.
        #
        # This checks that croncoind sends its own version prior to processing
