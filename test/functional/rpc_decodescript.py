...
class DecodeScriptTest(CronCoinTestFramework):
    ...
    def decodescript_script_pub_key(self):
        ...
        assert_equal('crnrt1pfees27x7qe', rpc_result['address'])
    ...
    def decodescript_miniscript(self):
        ...
        # Sourced from https://github.com/croncoin/croncoin/pull/27037#issuecomment-1416151907.
        ...
        assert res["segwit"]["desc"] == "addr(crnrt1q73qyfypp47hvgnkjqnav0j3k2lq3v76wg22dk8tmwuz5sfgv66xsmxdzfn)#4m35vxmd"
