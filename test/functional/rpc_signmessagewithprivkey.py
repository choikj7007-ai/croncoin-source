...
class SignMessagesWithPrivTest(CronCoinTestFramework):
    ...
    def run_test(self):
        ...
        expected_signature = 'H7W2DZoOkMcofEU198EdPbctWPTujo8EFLOWptU/4z/QZ6WMspm2NOVE2WomYCWK04O8JGlboCrWaIbjlMFm4Wk='
