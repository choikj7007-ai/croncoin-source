...
"""  Tests the coin_selection:* tracepoint API interface.
     See https://github.com/croncoin/croncoin/blob/master/doc/tracing.md#context-coin_selection
"""
...
class CoinSelectionTracepointTest(CronCoinTestFramework):
    ...
    def run_test(self):
        ...
        assert_raises_rpc_error(-6, "Insufficient funds", wallet.sendtoaddress, wallet.getnewaddress(), 102 * 600000)
