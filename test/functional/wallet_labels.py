...
class WalletLabelsTest(CronCoinTestFramework):
    ...
    def test_label_named_parameter_handling(self):
        ...
        self.log.info("Test croncoin-cli -named passes parameter containing '=' by position if it does not specify a known parameter name and is in a string position")
    ...
    def run_test(self):
        ...
        assert_equal(node.getbalance(), 1200000)

        # there should be 2 address groups
        # each with 1 address with a balance of 50 CronCoins
        ...
        for address_group in address_groups:
            ...
            assert_equal(address_group[0][1], 600000)
            assert_equal(address_group[0][2], 'coinbase')
            linked_addresses.add(address_group[0][0])

        # send from both addresses to a third address not in this wallet
        common_address = "msf4WtN1YQKXvNtvdFYt9JBnUD2FB41kjr"
        node.sendmany(
            amounts={common_address: 1200000},
        ...
        BECH32_VALID = {
            '✔️_VER15_PROG40': 'crnrt10qqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqtac8hf',
            '✔️_VER16_PROG03': 'crnrt1sqqqqqt6m8pl',
            '✔️_VER16_PROB02': 'crnrt1sqqqqv54l03',
        }
        BECH32_INVALID = {
            '❌_VER15_PROG41': 'crnrt1sqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqyqfqxz',
            '❌_VER16_PROB01': 'crnrt1sqqnpm33e',
        }
