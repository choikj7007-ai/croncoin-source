...
class TxnMallTest(CronCoinTestFramework):
    ...
    def run_test(self):
        ...
        # Node0's total balance should be starting balance, plus 1200000 CRN for
        # two more matured blocks, minus 1240 for the double-spend, plus fees (which are
        # negative):
        expected = starting_balance + 1200000 - 1240 + fund_foo_tx["fee"] + fund_bar_tx["fee"] + doublespend_fee
        assert_equal(self.nodes[0].getbalance(), expected)

        # Node1's balance should be its initial balance (15000000 for 25 block rewards) plus the doublespend:
        assert_equal(self.nodes[1].getbalance(), 15000000 + 1240)
