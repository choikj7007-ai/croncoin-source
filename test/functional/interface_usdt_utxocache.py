...
""" Tests the utxocache:* tracepoint API interface.
    See https://github.com/croncoin/croncoin/blob/master/doc/tracing.md#context-utxocache
"""
...
class UTXOCacheTracepointTest(CronCoinTestFramework):
    ...
    def test_uncache(self):
        ...
        https://github.com/croncoin/croncoin/blob/master/doc/tracing.md#tracepoint-utxocacheuncache
        """
        ...
        def handle_utxocache_uncache(_, data, __):
            ...
            try:
                ...
                assert_equal(600000 * COIN, event.value)
    ...
    def test_add_spent(self):
        """ Tests the utxocache:add utxocache:spent tracepoint API
            See https://github.com/croncoin/croncoin/blob/master/doc/tracing.md#tracepoint-utxocacheadd
            and https://github.com/croncoin/croncoin/blob/master/doc/tracing.md#tracepoint-utxocachespent
        """
    ...
    def test_flush(self):
        """ Tests the utxocache:flush tracepoint API.
            See https://github.com/croncoin/croncoin/blob/master/doc/tracing.md#tracepoint-utxocacheflush"""
