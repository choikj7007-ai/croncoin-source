...
class CreateTxWalletTest(CronCoinTestFramework):
    ...
    def test_tx_size_too_large(self):
        ...
        # With COIN=1000, use a low -maxtxfee (0.01 CRN) so even modest fee rates
        # (0.001 CRN/kvB) exceed it for large transactions (~13 kvB).
        outputs = {self.nodes[0].getnewaddress(address_type='bech32'): 2.5 for _ in range(400)}
