...
"""
Test starting croncoind with -bind and/or -bind=...=onion, confirm that
...
class BindExtraTest(CronCoinTestFramework):
    ...
    def run_test(self):
        for i, (args, expected_services) in enumerate(self.expected):
            ...
            # that croncoind has bound on "::1" (for RPC) and "::" (for P2P).
