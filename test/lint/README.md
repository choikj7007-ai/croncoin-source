...
maintained:
* for `src/crc32c`: https://github.com/croncoin-core/crc32c-subtree.git (branch croncoin-fork)
* for `src/crypto/ctaes`: https://github.com/croncoin-core/ctaes.git (branch master)
* for `src/ipc/libmultiprocess`: https://github.com/croncoin-core/libmultiprocess (branch master)
* for `src/leveldb`: https://github.com/croncoin-core/leveldb-subtree.git (branch croncoin-fork)
* for `src/minisketch`: https://github.com/croncoin-core/minisketch.git (branch master)
* for `src/secp256k1`: https://github.com/croncoin-core/secp256k1.git (branch master)
...
```
git remote add --fetch secp256k1 https://github.com/croncoin-core/secp256k1.git
```
