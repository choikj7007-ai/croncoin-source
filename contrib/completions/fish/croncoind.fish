...
complete --command croncoind --no-files

# Extract options
function __fish_croncoind_get_options
...
complete \
    --command croncoind \
    --arguments "(__fish_croncoind_get_options --nofiles)"
