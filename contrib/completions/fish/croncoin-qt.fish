...
complete --command croncoin-qt --no-files

# Extract options
function __fish_croncoinqt_get_options
...
complete \
    --command croncoin-qt \
    --arguments "(__fish_croncoinqt_get_options --nofiles)"
