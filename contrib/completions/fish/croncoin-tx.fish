...
# Extract options
function __fish_croncoin_tx_get_options
...
# Extract commands
function __fish_croncoin_tx_get_commands
...
complete \
    --command croncoin-tx \
    --condition "not __fish_croncoin_seen_cmd (__fish_croncoin_tx_get_commands --commandsonly)" \
    --arguments "(__fish_croncoin_tx_get_options)" \
    --no-files

# Add commands
complete \
    --command croncoin-tx \
    --arguments "(__fish_croncoin_tx_get_commands)" \
    --no-files
