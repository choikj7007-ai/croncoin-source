...
declare -A LIBS
LIBS[cli]="libcroncoin_cli.a"
LIBS[common]="libcroncoin_common.a"
LIBS[consensus]="libcroncoin_consensus.a"
LIBS[crypto]="libcroncoin_crypto.a"
LIBS[node]="libcroncoin_node.a"
LIBS[util]="libcroncoin_util.a"
LIBS[wallet]="libcroncoin_wallet.a"
...
# https://github.com/croncoin/croncoin/issues/10102
