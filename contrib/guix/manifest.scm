...
(define* (make-croncoin-cross-toolchain target
                                       #:key
...
desirable for building CronCoin Core release binaries."
...
;; failure; see https://github.com/croncoin/croncoin/pull/27296.
    ...
    (cond ((string-suffix? "-mingw32" target)
          ...
          ((string-contains target "-linux-")
           (list bison
                 ...
                 (make-croncoin-cross-toolchain target)))
