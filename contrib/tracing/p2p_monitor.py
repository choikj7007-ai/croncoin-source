...
""" Interactive croncoind P2P network traffic monitor utilizing USDT and the
    net:inbound_message and net:outbound_message tracepoints. """

# This script demonstrates what USDT for CronCoin Core can enable. It uses BCC
...
def main(pid):
    ...
    croncoind_with_usdts.enable_probe(
