...
"""Example logging CronCoin Core utxo set cache flushes utilizing
    the utxocache:flush tracepoint."""

# USAGE:  ./contrib/tracing/log_utxocache_flush.py <pid of croncoind>
...
def main(pid):
    ...
    b = BPF(text=program, usdt_contexts=[croncoind_with_usdts])
