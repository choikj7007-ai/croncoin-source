...
def main():
    ...
    g = sys.stdout
    indir = sys.argv[1]
    g.write('// Copyright (c) The CronCoin Core developers\n')
    ...
    g.write('#ifndef CRONCOIN_CHAINPARAMSSEEDS_H\n')
    g.write('#define CRONCOIN_CHAINPARAMSSEEDS_H\n')
    g.write('/**\n')
    g.write(' * List of fixed seed nodes for the croncoin network\n')
    ...
    g.write('#endif // CRONCOIN_CHAINPARAMSSEEDS_H\n')
